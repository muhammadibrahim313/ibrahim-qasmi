...
const Navigation = () => {
  ...
  return (
    <>
      ...
      <nav 
        id="expandable-navbar"
        className="fixed top-6 left-1/2 transform -translate-x-1/2 z-40 transition-all duration-400 ease-in-out"
      ...
      >
        <div 
          className={`
            ...
            ${isExpanded 
              ? 'rounded-2xl w-[90vw] max-w-6xl' 
              : 'rounded-full w-48 lg:w-56'
            }
          `}
          style={{
            ...
            boxShadow: isExpanded 
              ? '0 25px 50px -12px rgba(8, 145, 178, 0.25), 0 0 40px rgba(8, 145, 178, 0.1)' 
            ...
            >
              <div className="flex items-center justify-between h-16 px-6">
                ...
                <div className="lg:hidden flex flex-wrap items-center gap-2 max-w-xs">
                  {primaryNavItems.slice(0, 3).map((item, index) => (
                    <button
                      key={item.id}
                      onClick={(e) => {
                        e.stopPropagation();
                  ...
                  <button
                    ...
                    className="px-2 py-1 text-xs font-medium rounded text-foreground hover:text-primary hover:bg-primary/5 transition-all duration-200"
                    style={{
              ...
              {/* Mobile Dropdown */}
              {isDropdownOpen && (
                <div className="lg:hidden border-t border-border bg-card/95 backdrop-blur-sm rounded-b-2xl">
                  <div className="py-4 px-6 space-y-1 max-h-60 overflow-y-auto">
                    {[...primaryNavItems.slice(3), ...secondaryNavItems].map((item, index) => (
                      <button
                        key={item.id}
                        onClick={(e) => {
                          e.stopPropagation();
                        ...
                        className={`w-full text-left px-4 py-2 text-sm font-medium rounded-lg transition-all duration-200 ${
                          activeSection === item.id
                            ? 'text-primary bg-primary/10'
                            : 'text-foreground hover:text-primary hover:bg-primary/5'
                        }`}
