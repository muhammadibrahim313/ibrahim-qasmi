...
const Achievements = () => {
  ...
  const kaggleCompetitions = [
    ...
    },
    {
      ...
      result: "🥈 Silver Medal",
      description: "Designed the smallest possible neural networks to solve ARC-AGI image transformations. Submitted ONNX-formatted networks jointly minimizing size and parameter count. Part of IJCAI-ECAI 2026 Competitions Track ($50K prize pool).",
      teams: "2963 teams",
      rank: "26th",
      image: neurogolfImage,
      icon: <Medal className="h-5 w-5" />,
