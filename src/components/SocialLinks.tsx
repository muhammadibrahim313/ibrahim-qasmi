...
const SocialLinks = () => {
  const socialLinks = [
    ...
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/in/ibrahimqasmi313/',
      logo: (
    ...
    },
    {
      ...
      logo: (
        <div className="h-6 w-6 rounded-full bg-white flex items-center justify-center p-0.5">
          <img src={scholarLogo} alt="Google Scholar" className="h-full w-full object-contain" />
        </div>
      ),
